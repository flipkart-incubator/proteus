...
public class RecyclerViewModule implements ProteusBuilder.Module {
    ...
    @NonNull private final RecyclerViewAdapterFactory adapterFactory;

    @NonNull private final LayoutManagerFactory layoutManagerFactory;
     ...
     * {@link RecyclerViewParser#ATTRIBUTE_ADAPTER} attribute.
     * @param layoutManagerFactory The layout manager factory to evaluate the
     * {@link RecyclerViewParser#ATTRIBUTE_LAYOUT_MANAGER} attribute.
     */
    RecyclerViewModule(@NonNull RecyclerViewAdapterFactory adapterFactory,
        @NonNull LayoutManagerFactory layoutManagerFactory) {
     ...
     * exclude them call {@link #excludeDefaultAdapters()} and
     * {@link #excludeDefaultLayoutManagers()}.
     *
     * @author adityasharat
    ...
    public static class Builder {
        ...
        @NonNull private final RecyclerViewAdapterFactory adapterFactory =
            new RecyclerViewAdapterFactory();

        @NonNull private LayoutManagerFactory layoutManagerFactory = new LayoutManagerFactory();
         ...
         * </p>
         *
         * @param type The 'type' of the adapter which will be used in the
         * {@link RecyclerViewParser#ATTRIBUTE_ADAPTER} attribute.
         * @param builder The builder for the adapter.
         * @return this builder.
         */
        public Builder register(@NonNull String type,
            @NonNull ProteusRecyclerViewAdapter.Builder builder) {
         ...
         * </p>
         *
         * @param type The {@link RecyclerViewParser#ATTRIBUTE_TYPE} of the layout manager which
         * will
         * be used in the {@link RecyclerViewParser#ATTRIBUTE_LAYOUT_MANAGER} attribute.
        ...
        /**
         * <p>
         * Will exclude the default {@link ProteusRecyclerViewAdapter} implementations from the
         * module.
         * </p>
         *
         * @return this builder.
