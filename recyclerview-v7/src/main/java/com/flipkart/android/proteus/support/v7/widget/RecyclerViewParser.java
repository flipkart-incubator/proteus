...
public class RecyclerViewParser<V extends RecyclerView> extends ViewTypeParser<V> {
    ...
    protected void addAttributeProcessors() {
                ...
                if (value.isObject()) {
                    ...
                    if (type != null) {
                        ProteusRecyclerViewAdapter adapter =
                            adapterFactory.create(type, (ProteusRecyclerView) view, value.getAsObject());
                ...
                if (value.isObject()) {
                    ...
                    if (type != null) {
                        RecyclerView.LayoutManager layoutManager =
                            layoutManagerFactory.create(type, (ProteusRecyclerView) view, value.getAsObject());
        ...
        addAttributeProcessor("itemMargin", new DimensionAttributeProcessor<V>() {
            @Override
