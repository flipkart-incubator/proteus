...
public class Array extends Value {
    ...
    /**
     * convenience method to get this array as a double if it contains a single value.
     *
     * @return get this value as a double if it is single value array.
     * @throws ClassCastException    if the value in the array is of not a {@link Primitive} and
    ...
    public double getAsDouble() {
        if (values.size() == 1) {
            return values.get(0).getAsDouble();
        }
        throw new IllegalStateException();
    }

    /**
     * convenience method to get this array as a float if it contains a single value.
     *
     * @return get this value as a float if it is single value array.
     * @throws ClassCastException    if the value in the array is of not a {@link Primitive} and
    ...
    public float getAsFloat() {
        if (values.size() == 1) {
            return values.get(0).getAsFloat();
        }
        throw new IllegalStateException();
    }

    /**
     * convenience method to get this array as a long if it contains a single value.
     *
     * @return get this value as a long if it is single value array.
     * @throws ClassCastException    if the value in the array is of not a {@link Primitive} and
     *                               is not a valid long.
     * @throws IllegalStateException if the array has more than one value.
     */
    ...
    public long getAsLong() {
        if (values.size() == 1) {
            return values.get(0).getAsLong();
        }
        throw new IllegalStateException();
    }

    /**
     * convenience method to get this array as an integer if it contains a single value.
     *
     * @return get this value as an integer if it is single value array.
     * @throws ClassCastException    if the value in the array is of not a {@link Primitive} and
    ...
    public char getAsCharacter() {
        if (values.size() == 1) {
            return values.get(0).getAsCharacter();
        }
        throw new IllegalStateException();
    }

    /**
     * convenience method to get this array as a boolean if it contains a single value.
     *
     * @return get this value as a boolean if it is single value array.
     * @throws ClassCastException    if the value in the array is of not a {@link Primitive} and
    ...
    public boolean getAsBoolean() {
        if (values.size() == 1) {
            return values.get(0).getAsBoolean();
        }
        throw new IllegalStateException();
    }
