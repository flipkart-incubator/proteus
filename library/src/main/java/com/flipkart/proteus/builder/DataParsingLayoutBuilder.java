...
import com.flipkart.proteus.binding.Binding;
import com.flipkart.proteus.exceptions.InvalidDataPathException;
import com.flipkart.proteus.exceptions.JsonNullException;
import com.flipkart.proteus.exceptions.NoSuchDataPathException;
import com.flipkart.proteus.parser.LayoutHandler;
...
import com.flipkart.proteus.view.manager.ProteusViewManagerImpl;
    ...
    protected void handleChildren(LayoutHandler handler, ProteusView view) {
        ...
        if (element != null) {
            ...
            for (int index = 0; index < length; index++) {
                ProteusView child = build((View) view, childLayout, viewManager.getDataContext().getData(), index, viewManager.getStyles());
                if (child != null) {
