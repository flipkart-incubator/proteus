...
public class DesignCollection implements ProteusBuilder.Collection {

    private DesignCollection() {
    }

    public static DesignCollection create() {
        return new DesignCollection();
    }
